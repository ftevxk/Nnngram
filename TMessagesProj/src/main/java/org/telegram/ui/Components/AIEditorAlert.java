...
public class AIEditorAlert extends BottomSheetWithRecyclerListView {
    ...
    public AIEditorAlert(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        for (String style : styles) {
            ...
            toneTitles[styleIndex] = localizedToneTitle(p[0], p[2]);
            styleIndex++;
        }
...
//            }
    ...
    private static String localizedToneTitle(String toneName, String fallback) {
        if (toneName == null) return fallback;
        switch (toneName.toLowerCase()) {
            case "formal": return getString(R.string.AIEditorToneFormal);
            case "short": return getString(R.string.AIEditorToneShort);
            case "tribal": return getString(R.string.AIEditorToneTribal);
            case "corp": return getString(R.string.AIEditorToneCorp);
            case "biblical": return getString(R.string.AIEditorToneBiblical);
            case "viking": return getString(R.string.AIEditorToneViking);
            case "zen": return getString(R.string.AIEditorToneZen);
