...
//            }
    ...
    private void invalidateActionBar() {
        ...
        if (actionBar.backButtonImageView != null) {
            ((ImageView)actionBar.backButtonImageView).setColorFilter(new PorterDuffColorFilter(ColorUtils.blendARGB(getColor(Theme.key_actionBarDefaultIcon), actionBarColors.getColor(key_windowBackgroundWhiteBlackText), actionBarTransitionProgress), PorterDuff.Mode.SRC_IN));
        }
...
//        }
    ...
    public static class ActionBarColorsAnimating {
        ...
        public void updateActionBar(ActionBar actionBar, float progress) {
            ...
            if (actionBar.backButtonImageView != null) {
                ((ImageView)actionBar.backButtonImageView).setColorFilter(new PorterDuffColorFilter(getColor(Theme.key_windowBackgroundWhiteBlackText), PorterDuff.Mode.SRC_IN));
            }
